        ...
        <Row className="massafeTextAndSeen">
          ...
          {isFile &&
            text.map((value) => {
              ...
              if (
                ...
                return (
                  <Col
                    span={lengText === 1 ? 24 : lengText === 2 ? 12 : 8}
                    className="text_file">
                ...
                return (
                  <Col span={lengText === 1 ? 24 : lengText === 2 ? 12 : 8}>
                    <img src={value} className="text_image" alt=''/>
                  </Col>
                );
            })}
          ...
          {_.size(message.seens) <= 1 && message.sender === 1 && (
            <>
              <img
                className="image_text"
                src="https://img.icons8.com/external-kiranshastry-gradient-kiranshastry/13/000000/external-check-multimedia-kiranshastry-gradient-kiranshastry.png"
                alt=""
              />
            </>
          )}
