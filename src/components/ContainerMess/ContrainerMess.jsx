...
import {findIndexLastTextSeen,addSpantoText,findIndexFromArrayLodash, findObjectFromArrayLodash} from '../../helper/functions'
...
library.add(fab,faPhone,faInfoCircle,faPlusCircle,faPortrait,faAirFreshener,faGift,
  faArrowAltCircleRight,faThumbsUp,faSearch,faChevronDown,faChevronUp,faUpload,faSearch,faSmileWink) 
            ...
            <div className="container-main">
                    ...
                    <div className="container-main__bottom">
                        ...
                        <div className="container-main__bottom-right">
                            ...
                            {showRightMess && <ContainerRight infoRoom={profileFriend} members={currentConversation?.members} messenger={messages}/>}
        </>
    );
})
